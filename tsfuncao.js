...
function exibirSaudacao1() {
    console.log("Olá Mundo !");
}
exibirSaudacao1();
//outra 
var mensagem = "Carlos";
function exibirSaudacao2(mens) {
    console.log("Bom dia ".concat(mens, " !"));
}
exibirSaudacao2(mensagem);
//outra
var mensagem1 = readline_sync_1.default.question("Digite seu nome - ");
var diahoje = readline_sync_1.default.questionInt("Digite a dia do mes - ");
var meshoje = readline_sync_1.default.questionInt("Digite o mes (1 a 12) - ");
function exibirSaudacao3(mens, dia, mes) {
    console.log("Bom dia ".concat(mens, " hoje \u00E9 ").concat(dia, "/").concat(mes, " !"));
}
